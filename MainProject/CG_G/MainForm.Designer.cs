namespace CG_G
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Прямая. Алгоритм Брезенхема";
			...
			this.button2.Text = "Гипербора. Алгоритм Брезенхема";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(74, 158);
			...
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(262, 158);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(136, 58);
			this.button4.TabIndex = 3;
			this.button4.Text = "Многоугольник и прямоугольник";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.button4_Click);
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(167, 255);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(128, 58);
			this.button5.TabIndex = 4;
			this.button5.Text = "Поверхности";
