namespace CG_G
{
	partial class Task5
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Введите координаты проекции точки на поверхности\r\nнижнего цилиндра в горизонтальн" +
    "ую плоскость:\r\n";
			// 
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(552, 68);
			...
			this.label4.Text = "Введите координаты проекции точки на поверхности\r\nверхнего цилиндра в горизонталь" +
    "ную плоскость:\r\n";
			// 
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(552, 174);
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(552, 200);
			...
			this.label5.Location = new System.Drawing.Point(487, 177);
			this.label5.Name = "label5";
			this.label5.Size = new System.Drawing.Size(59, 13);
			this.label5.TabIndex = 9;
			this.label5.Text = "x ∈ [0, 12]:";
			// 
			// label6
			// 
			...
			this.button1.Text = "Построить касание";
